...
def main():
    ...
    parser.add_argument('--training_patch_size', type=int, default=48,
                        help='patch size used in training SwinIR. ')
    parser.add_argument('--large_model', action='store_true',
                        help='use large model, only provided for real image')
    parser.add_argument('--model_path', type=str,
                        default='model_zoo/model_final.pth')
    ...
    if os.path.exists(args.model_path):
        ...
        dir = 'https://github.com/JingyunLiang/SwinIR/releases/download/v0.0/'
        url = '{}{}'.format(dir, os.path.basename(args.model_path))
...
def get_image_pair(args, path):
    ...
    # 001 classical image sr (load lq-gt image pairs)
    if args.task in ['classical_sr']:
        img_gt = None
